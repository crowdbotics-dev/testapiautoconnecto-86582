...
## Project Structure
    ...
    ├── testapiautoconnecto_86582  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_86582`
...
2. Clone this repo and `cd testapiautoconnecto_86582`
